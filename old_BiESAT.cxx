...
- This can't handle changing the x-axis into units of MeV but
  units of keV are fine.
...
Int_t verbose=2;
Double_t eg_diff=576; // difference between 500keV gamma and the 976keV electron.

void BiESAT_old(string runnumber,Int_t dbtmp=0){
  ...
  TCanvas *ctmp = new TCanvas("ctmp","ctmp",0,0,100,100);
  ctmp->cd();
  ...
  func->SetParLimits(3,360.*calib,420.*calib);
  ...
  if(!lowres) calib = (((cedge1000+gausmean1000)/2)-cedge500)/470.;
  if(lowres)  calib = (cedge1000-cedge500)/460.;
  ...
  //func->SetParLimits(17,400.*calib,Ek482*1.5);
  func->SetParameter(17,470*calib);
  func->SetParLimits(17,420.*calib,490*calib);
  ...
  func->SetParLimits(21,Ek976*0.5,Ek976*1.5);
  ...
  ///////////////////////////////////////////////////////////////////
  TCanvas *c72 = new TCanvas("c72","- Rough Fit 1 -",xsize,0,xsize,ysize);
  c72->cd();
  xmin=280*calib;
  xmax=1200*calib;
  ...
  nEk482       = Ek482;
  if(ADC_offset>0){
    nEk976     = Ek976+ADC_offset;
    nEk482     = Ek482+ADC_offset;
  }
  ns976        = s976;
  ...
  if(lowres){
    ...
    func->SetParameter(2,N500);
    //func->SetParLimits(2,N500*m,N500*p);
    func->SetParLimits(2,0.01,1.0e4);
    //func->ReleaseParameter(3);
    //func->SetParameter(3,cedge500);
    //func->SetParLimits(3,cedge500*m,cedge500*p);
    ...
    //func->SetParLimits(9,N1000*m,N1000*p);
    func->SetParLimits(9,0.01,1.0e4);
    //func->ReleaseParameter(10);
    //func->SetParameter(10,cedge1000);
    //func->SetParLimits(10,cedge1000*m,cedge1000*p);
  ...
  ///////////////////////////////////////////////////////////////////
  TCanvas *c73 = new TCanvas("c73","- Rough Fit 2 -",xsize,0,xsize,ysize);
  c73->cd();
  xmin=280*calib;
  xmax=1200*calib;
  if(xmax>hmax) xmax=hmax;
  ...
  ADC_offset   = calib*((976.-Eloss)-(Ek976/calib));
  nEk976       = Ek976;
  nEk482       = Ek482;
  if(ADC_offset>0){
    nEk976     = Ek976+ADC_offset;
  ...
  ///////////////////////////////////////////////////////////////////
  TCanvas *c74 = new TCanvas("c74","- Final Fit -",xsize,0,xsize,ysize);
  c74->cd();
  xmin=280*calib;
  xmax=1200*calib;
  //xmax=Ek976+(10*s976);
  ...
  ///////////////////////////////////////////
  quickfit_976kev(sub,Ek976-(1.3*s976),Ek976,Ek976+(3.0*s976),4,"AA_quickfit-976keV");
...
void megaPrint(){
  ...
  //cout<<" Root-file:   "<<(workdir+rootfile).c_str()<<endl;
  //cout<<" Config-file: "<<(workdir+configfile).c_str()<<endl;
  ...
  cout<<"\n 976keV ADC Offset and Pedestal Sigma Contribution "<<endl;
  cout<<"\t ADC Offset    = "<<ADC_offset<<" bins = "
      <<ADC_offset/cal976<<" keV"<<endl;
  ...
  cout<<"\n 482keV ADC Offset and Pedestal Sigma Contribution "<<endl;
  cout<<"\t ADC Offset    = "<<ADC_offset<<" bins = "
      <<ADC_offset/cal482<<" keV"<<endl;
  ...
  //outfile<<" Root-file:   "<<rootfile<<endl;
  //outfile<<" Root-file:   "<<(workdir+rootfile).c_str()<<endl;
  //outfile<<" Config-file: "<<(workdir+configfile).c_str()<<endl;
  ...
  outfile<<"\n 976keV ADC Offset and Pedestal Sigma Contribution "<<endl;
  outfile<<"\t ADC Offset    = "<<ADC_offset<<" bins = "
	 <<ADC_offset/cal976<<" keV"<<endl;
